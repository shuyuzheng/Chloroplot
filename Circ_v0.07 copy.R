...
mboard=function(gbFile,rad=100, cexlab=0.4, gene.width=5, offset=1, gay=TRUE, intron.width=3){
  ...
  Arc.plotter<- function (theta0, theta1, radius.in, radius.out, center.x = 0, center.y = 0, edges = 10, col = "black", border = NA, ...) {
    if (length(edges) == 1) 
  ...
  if (gay){pal<- sample(1:999, Nrg)}
  else {pal<- rep(Nrg, "black")}
